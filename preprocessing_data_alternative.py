...
p_cond = np.load("P_cond_optimized_alternative.npy")
...
if __name__ == "__main__":
    ...
    preprocess_compas(df_train, p_cond, "pre-processed-alternative-compas-scores-cleaned-trained.csv")

    df_test = pd.read_csv("compas-scores-cleaned-test.csv")
    preprocess_compas(df_test, p_cond, "pre-processed-alternative-compas-scores-cleaned-test.csv")